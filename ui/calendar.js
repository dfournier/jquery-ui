...
return $.widget( "ui.calendar", {
	...
	_create: function() {
		...
		this._on( this.element, {
			...
			"mouseenter .ui-calendar-header a, .ui-calendar-calendar a": "_hover",
			"mouseleave .ui-calendar-header a, .ui-calendar-calendar a": "_hover",
	...
	refresh: function() {
		...
		if ( this.options.numberOfMonths === 1 ) {
			...
			$( ".ui-calendar-prev", this.element ).replaceWith( this._buildPreviousLink() );
			$( ".ui-calendar-next", this.element ).replaceWith( this._buildNextLink() );
			this.element.find( "button" ).button();
		} else {
